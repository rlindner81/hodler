...
DROP TABLE IF EXISTS t_cash_transaction_type;
DROP TABLE IF EXISTS t_cash_transaction;
DROP TABLE IF EXISTS t_security_transaction_type;
DROP TABLE IF EXISTS t_security_transaction;
...
VALUES ('AMD220121C00077500', 'USD', 'OPTION', 'AMD')
;
...
(
    ...
    security_transaction VARCHAR(256) REFERENCES t_security_transaction (id)
);
